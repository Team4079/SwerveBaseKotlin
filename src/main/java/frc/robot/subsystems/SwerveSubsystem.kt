...
class SwerveSubsystem(photonvision: PhotonVision?) : SubsystemBase() {
  ...
  init {
    ...
    AutoBuilder.configureHolonomic(
      ...
      Consumer { pose: Pose2d? ->  // Method to reset odometry (will be called if your auto has a starting pose)
        this.newPose(pose)
      },
      Supplier { this.getAutoSpeeds() }, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
      Consumer { chassisSpeeds: ChassisSpeeds? -> // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
